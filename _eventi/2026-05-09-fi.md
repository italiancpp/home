...
![main picture](/assets/images/eventi/meetup-fi26.jpg)

Bjarne Stroustrup, the creator of C++, was the special guest of this unique Italian C++ Community meetup in Florence, organized by the Italian C++ Community, the University of Pisa (DII), and the University of Florence (DINFO).

We thank the 17th ACM/SPEC International Conference on Performance Engineering ([ICPE 2026](https://icpe2026.spec.org/)) for contributing to Bjarne Stroustrup's visit to Italy.

<p style="font-size:25px;font-weight:bold">We had 280 attendees!</p>

An exceptional morning with one of the brightest minds in modern computer science: a technical talk followed by an open Ask Me Anything (AMA) session.

See some pictures [here](https://www.facebook.com/media/set/?set=a.1564601942340090&type=3).
...
❤️ Organized with passion by the Italian C++ Community, the University of Firenze and the University of Pisa
